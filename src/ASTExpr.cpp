...
llvm::Value *BinaryExprAST::codegen() {
  ...
  switch(Op) {
    ...
    case '<':
      ...
      return CodeGen::Builder->CreateUIToFP(L, llvm::Type::getDoubleTy(*CodeGen::Context),
                                            "booltmp");
    default:
...
llvm::Function *ProtoTypeAST::codegen() {
  ...
  std::vector<llvm::Type*> Doubles(Args.size(), llvm::Type::getDoubleTy(*CodeGen::Context));
  llvm::FunctionType *FT = llvm::FunctionType::get(llvm::Type::getDoubleTy(*CodeGen::Context), Doubles, false);

  llvm::Function *F = llvm::Function::Create(FT, llvm::Function::ExternalLinkage, Name, CodeGen::Module.get());
